...
public class ScrollLayout extends ViewGroup {
	...
	public static final int mDefaultScreen = 0;
    ...
    public void snapToScreen(int whichScreen) {
    	...
    	if (getScrollX() != (whichScreen*getWidth())) {
    		...
    		mScroller.startScroll(getScrollX(), 0, delta, 0, Math.abs(delta)*2/3); //wwz mScroller.startScroll(getScrollX(), 0, delta, 0, Math.abs(delta)*2); 
