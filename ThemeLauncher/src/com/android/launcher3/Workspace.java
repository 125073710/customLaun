...
public class Workspace extends SmoothPagedView
    ...
    */
    ...
    static class AlphaUpdateListener implements AnimatorUpdateListener, AnimatorListener {
        ...
        public void onAnimationStart(Animator arg0) {
          ...
          //ybf   view.setVisibility(VISIBLE);
        }
    }
  ...
  //ybf2017-1-18 防止报空      getUniqueIntents((CellLayout) mLauncher.getHotseat().getLayout(), uniqueIntents, duplicates, false);
        int count = getChildCount();
        for (int i = 0; i < count; i++) {
            CellLayout cl = (CellLayout) getChildAt(i);
